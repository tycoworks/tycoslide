    ...
    lines: {
      variants: {
        default: linesLayout.tokenMap({
          ...
          eyebrow: headerEyebrow,
          headerSpacing: spacingTight,
          label: { style: TEXT_STYLE.SMALL, color: palette.gray600, hAlign: HALIGN.LEFT, vAlign: VALIGN.MIDDLE },
          solid: { color: palette.navy, width: 2, dashType: DASH_TYPE.SOLID },
          dash: { color: palette.purple, width: 2, dashType: DASH_TYPE.DASH },
          lgDash: { color: palette.brick, width: 2, dashType: DASH_TYPE.LG_DASH },
          dashDot: { color: palette.emerald, width: 2, dashType: DASH_TYPE.DASH_DOT },
          lgDashDot: { color: palette.amber, width: 2, dashType: DASH_TYPE.LG_DASH_DOT },
          sysDot: { color: palette.skyBlue, width: 2, dashType: DASH_TYPE.SYS_DOT },
          sysDash: { color: palette.gray600, width: 2, dashType: DASH_TYPE.SYS_DASH },
          vAlign: VALIGN.TOP,
          hAlign: HALIGN.LEFT,
          spacing: spacing,
        }),
