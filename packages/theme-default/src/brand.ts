...
const light: Palette = {
  text: { heading: "#1A1A2E", body: "#1A1A2E", description: "#4A4A5A", subtle: "#696878", highlight: "#7C3AED" },
...
const dark: Palette = {
  text: { heading: "#FFFFFF", body: "#E5E5E5", description: "#A0A0B0", subtle: "#9898A8", highlight: "#A78BFA" },
