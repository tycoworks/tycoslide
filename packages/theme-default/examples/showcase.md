...
eyebrow: The Product
body: "A presentation :purple[**build tool**] that generates :purple[**editable PowerPoint files**] from markdown and TypeScript, with :purple[**theme-based styling**] and build-time validation."
variant: hero
...
cards:
  ...
  - title: Brand Compliance
    description: Design tokens encode your brand in code. Invalid designs fail the build. Brand consistency is automatic.
    image: $icons.shield
...
- CI/CD pipelines — Build decks on push. Brand issues fail the build.
...
image: $icons.shield
notes: |
  Supporting argument 2. Compile-time brand validation.
...
Brand guidelines become code that the build system applies automatically — not PDFs that people forget to read.
...
| Brand consistency | Design tokens | Manual templates | Manual CSS | AI-generated |
